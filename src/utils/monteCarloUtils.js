 ...
 * Provides functions for running Monte Carlo simulations on project data
 */

// Constants
const HOURS_PER_STORY = {
 ...
 * @param {Date} baseDate - Original deadline date
 * @param {number} additionalDays - Additional working days
 ...
 * @param {Array} simulatedCRs - Array of simulated CR data
 * @param {Object} projectParams - Project parameters
 * @param {Object} simulatedCapacity - Simulated team capacity
...
export const calculateImpactForSimulation = (simulatedCRs, projectParams, simulatedCapacity) => {
  ...
  // Calculate available capacity (assuming standard allocation percentages)
 ...
 * @param {Object} projectParams - Project parameters
 * @returns {Object} Analyzed simulation results
 */
...
/**
 * Run Monte Carlo simulation for timeline forecasting
